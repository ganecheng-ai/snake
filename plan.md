...
- **状态**: 稳定运行
- **最近更新时间**: 2026-03-12
- **最新检查**: 2026-03-12 - 添加排行榜功能，记录各模式前10名成绩

## 版本历史
- v1.5.0: 添加排行榜功能，记录各模式前10名成绩
- v1.4.0: 添加皮肤系统，支持5种皮肤选择（翠绿、深蓝、紫罗兰、金色、火焰）
- v1.3.0: 添加多种游戏模式（经典模式、限时模式、无尽模式）
- v1.2.8: 添加暂停时的背景模糊效果，提升用户体验
- v1.2.7: 修复 Windows 版本启动报错，添加 numpy 依赖解决 pygame.sndarray 模块缺失问题
